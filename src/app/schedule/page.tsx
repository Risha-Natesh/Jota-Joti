...
const schedule = {
  chamundi: {
    ...
    day2: [
        { time: "09:00 AM - 10:00 AM", event: "Registrations for Scouts and Guides Judging Camp", icon: <Zap className="w-5 h-5" /> },
        { time: "10:00 AM - 12:00 PM", event: "JOTI Station will be live / Community Volunteering", icon: <Radio className="w-5 h-5" /> },
  ...
  panchavati: {
    ...
    day2: [
        ...
        { time: "11:00 AM", event: "Demos / Exhibitions / workshops etc will go Live", icon: <PartyPopper className="w-5 h-5" /> },
